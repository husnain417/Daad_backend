...
public class ReviewRepository {
    ...
    private Review insert(Review review) {
        String sql = """
            INSERT INTO reviews (
                ...
                is_verified, status, helpful_count, created_at, updated_at
            ) VALUES (?, ?, ?, ?, ?, ?, ?::review_status, ?, NOW(), NOW())
            """;

        jdbcTemplate.update(sql,
            review.getProductId(),
            UUID.fromString(review.getCustomerId()),
            review.getRating(),
            review.getTitle(),
            review.getComment(),
        ...
        String id = jdbcTemplate.queryForObject(idSql, String.class, review.getProductId(), review.getCustomerId());
        review.setId(id);
    ...
    public List<Review> findByProductIdAndStatus(String productId, String status) {
        ...
        return jdbcTemplate.query(sql, reviewRowMapper, productId, status);
    }
    ...
    public long countByProductIdAndStatus(String productId, String status) {
        ...
        Integer count = jdbcTemplate.queryForObject(sql, Integer.class, productId, status);
    ...
    public Optional<Review> findOneByProductIdAndCustomerId(String productId, String customerId) {
        ...
        List<Review> reviews = jdbcTemplate.query(sql, reviewRowMapper, productId, customerId);
        return reviews.isEmpty() ? Optional.empty() : Optional.of(reviews.get(0));
    }
    ...
    public List<Review> findByCustomerIdAndStatus(String customerId, String status) {
        ...
        return jdbcTemplate.query(sql, reviewRowMapper, customerId, status);
    }
    ...
    public OptionalDouble averageRatingForProduct(String productId) {
        ...
        Double avgRating = jdbcTemplate.queryForObject(sql, Double.class, productId);
    ...
    public void updateHelpfulCount(String reviewId, int helpfulCount) {
        ...
        jdbcTemplate.update(sql, helpfulCount, reviewId);
    }
    ...
    public void updateVerificationStatus(String reviewId, boolean isVerified) {
        ...
        jdbcTemplate.update(sql, isVerified, reviewId);
    }
